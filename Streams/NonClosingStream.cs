...
namespace Xevle.IO.Streams
{
	...
	public sealed class NonClosingStream : Stream
	{
		...
		{
			get { return closed ? false : stream.CanTimeout; }
		}
		...
		/// </summary>
		/// <returns>Nothing, especially not an object of type ILease used to control the lifetime policy for this instance.</returns>
		/// <exception cref="NotSupportedException">Always.</exception>
